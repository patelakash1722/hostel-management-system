...
<?php	
$aid=$_SESSION['login'];
	$ret="select * from guest_booking where emailid=?";
...
<td><a href="javascript:void(0);"  onClick="popUpWindow('http://localhost/ak/hostel/full-profile.php?id=<?php echo $row->emailid;?>');" title="View Full Details">Print Data</a></td>
</tr>
<tr>
...
<td><b>Seater_type :</b></td>
<td><?php echo $row->seater_type;?></td>
<td><b>Fees PM :</b></td>
<td><?php echo $fpd=$row->feespd;?></td>
</tr>
...
$cnt=$cnt+1;
 ...
 <a href="../hostel/integrate-stripe-payment-gateway-in-php/index.php"><input type="submit" name="submit" border="0" value="Paid">
</div>
</div>
</div>
</div>
