...
$rc=$stmt->bind_param('iiiisiissisississsisssi',$roomno,$seater_type,$feespd,$foodstatus,$stayfrom,$duration,$regno,$name,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
$stmt->execute();
$stmt->close();
...
$stmt1->bind_param('issisi',$regno,$name,$gender,$contactno,$emailid,$password);
$stmt1->execute();
...
<input type="radio" value="1" name="foodstatus"> With Food(Rs 200.00 Per day Extra)
</div>
</div>	
