...
$rc=$stmt->bind_param('iiiisiissssisississsisssi',$roomno,$seater_type,$feespm,$foodstatus,$stayfrom,$duration,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
$stmt->execute();
$stmt->close();
