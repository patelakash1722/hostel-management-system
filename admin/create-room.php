...
{
$query="insert into  rooms (room_type_id,room_no,fees,guest_charges) values(?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiii',$room_type_id,$roomno,$fees,$guest_charges);
$stmt->execute();
...
<?php } ?>
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Select Seater_type  </label>
												<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">guest_charges(Per guest)</label>
<div class="col-sm-8">
<input type="text" class="form-control" name="guest_charges" id="guest_charges" value="" required="required">
</div>
</div>
