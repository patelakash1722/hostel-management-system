...
<?php 
		 $ret= mysqli_query($connect,"SELECT * FROM guest_booking where id = '".$_GET['id']."'");
			...
			<tr>
			  <td colspan="2"  class="font1"><table width="100%" border="0">
                <tr>
                  ...
                  <tr>
                  <td width="22%" valign="top" class="heading">Seater_type : </td>
                  
                      <td class="comb-value1"><span class="comb-value"><?php echo $row['seater_type'];?></span></td>
                    </tr>
                  
                    <tr>
                    <td width="12%" valign="top" class="heading">Fees PD : </td>
                      <td class="comb-value1"><?php echo $fpd=$row['feespd'];?></td>
                    </tr>
                     <tr>
