...
$id=$_GET['id'];
$query="update guest_booking set regno=?,duration=?, foodstatus=? where id=?";
...
<head>
	...
	<title>Edit guest booking Details</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit guest Details </h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Edit guest Details</div>
									<div class="panel-body">
										<form method="post" class="form-horizontal">
												<?php	
												$id=$_GET['id'];
	$ret="select * from guest_booking where id=?";
	 ...
	 //$cnt=1;
	   while($row=$res->fetch_object())
	  {
	  	?>
					...
					<div class="col-sm-8">
					<input type="text"  name="regno" value="<?php echo $row->regno;?>"  class="form-control" readonly> </div>
					</div>
				 <div class="form-group">
				<label class="col-sm-2 control-label">duration </label>
		<div class="col-sm-8">
	<input type="text" class="form-control" name="duration" id="duration" value="<?php echo $row->duration;?> days" >
