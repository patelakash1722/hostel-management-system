...
$query="insert into  user_booking(roomno,seater_type,feespm,foodstatus,stayfrom,duration,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('isiisisssssisississsisssi',$roomno,$seater_type,$feespm,$foodstatus,$stayfrom,$duration,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
$stmt->execute();
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row">
							...
							<?php
$uid=$_SESSION['login'];
							 $stmt=$mysqli->prepare("SELECT emailid FROM user_booking WHERE emailid=? ");
...
<div class="col-sm-8">
<select name="room" id="room"class="form-control"  onChange="getSeater_type(this.value);" onBlur="checkAvailability()" required> 
