...
$query="update  user_booking set ,duration=?,foodstatus=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iii',$duration,$foodstatus,$aid);
$stmt->execute();
echo"<script>alert('room details updated Succssfully');</script>";
}
?>
...
<input type="submit" id="update"name="update" Value="Update Profile" class="btn btn-primary">
</div>
</form>
